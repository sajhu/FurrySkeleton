...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8" />
	<title>Acceso Denegado - Activar ERP</title>
			...
			<div class="row-fluid">
				<div class="login-box">
					<div class="icons">
						...
						<a href="<?php echo BASE_URL;?>../contactenos.html"><i class="halflings-icon info-sign"></i></a>
					</div>
					<div style="text-align:center;">
						<img src="<?php echo IMAGE_URL;?>logo-login.png" alt="Activar SAS - ERP">
					</div>
						<fieldset>
							<h1 style="margin-left: 30px;">Acceso Denegado</h1>
							<p><strong>Error 403:</strong> Lo sentimos, no tiene el permiso necesario para acceder a esta página.</p>
							<p class="pull-right">
								<br>	
